...
@WebServlet("/signin") // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class Signin extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      try (
         ...
         //System.out.println("this is result: " + LoginDao.validate(email,password));
